...
function updateCart(pizza) {
  // install axios library to use AJAX
  axios.post('/update-carts', pizza).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function () {
    var pizzaJSON = btn.dataset.pizza; // data-pizza ở dạng JSON
    //let pizza = btn.getAttribute('data-pizza'); // thay vi su dung dataset ta có thể sử dụng getAttribute 

    var pizzaOBJ = JSON.parse(btn.dataset.pizza); // data-pizza được chuyển sang dạng Object để lưu vào Cart

    updateCart(pizzaOBJ); // console.log(pizzaOBJ);
  });
});
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["src/public/css/style"], () => (__webpack_require__("./src/resources/scss/app.scss")))
